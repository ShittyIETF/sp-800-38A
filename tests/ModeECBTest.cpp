...
template<>
Byte ModeECBTest::TestData<128>::AES_key[] = {
  0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7,
  0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c,
};

template<>
Byte ModeECBTest::TestData<128>::AES_plaintext[] = {
...
template<>
Byte ModeECBTest::TestData<128>::AES_ciphertext[] = {
...
template<>
Byte ModeECBTest::TestData<192>::AES_key[] = {
...
template<>
Byte ModeECBTest::TestData<192>::AES_plaintext[] = {
  0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d,
  0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a, 0xae, 0x2d, 0x8a, 0x57,
  0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf,
  0x8e, 0x51, 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11,
...
template<>
Byte ModeECBTest::TestData<192>::AES_ciphertext[] = {
...
template<>
Byte ModeECBTest::TestData<256>::AES_key[] = {
...
template<>
Byte ModeECBTest::TestData<256>::AES_plaintext[] = {
  0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d,
  0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a, 0xae, 0x2d, 0x8a, 0x57,
  0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf,
  0x8e, 0x51, 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11,
...
template<>
Byte ModeECBTest::TestData<256>::AES_ciphertext[] = {
  0xf3, 0xee, 0xd1, 0xbd, 0xb5, 0xd2, 0xa0, 0x3c, 0x06, 0x4b,
  0x5a, 0x7e, 0x3d, 0xb1, 0x81, 0xf8, 0x59, 0x1c, 0xcb, 0x10,
  0xd4, 0x10, 0xed, 0x26, 0xdc, 0x5b, 0xa7, 0x4a, 0x31, 0x36,
  0x28, 0x70, 0xb6, 0xed, 0x21, 0xb9, 0x9c, 0xa6, 0xf4, 0xf9,
  0xf1, 0x53, 0xe7, 0xb1, 0xbe, 0xaf, 0xed, 0x1d, 0x23, 0x30,
  0x4b, 0x7a, 0x39, 0xf9, 0xf3, 0xff, 0x06, 0x7d, 0x8d, 0x8f,
  0x9e, 0x24, 0xec, 0xc7,
};

int main() {
  Galileo::test("AES128EncryptionTest", ModeECBTest::AESEncryptionTest<128>);
  Galileo::test("AES128DecryptionTest", ModeECBTest::AESDecryptionTest<128>);
  Galileo::test("AES192EncryptionTest", ModeECBTest::AESEncryptionTest<192>);
  Galileo::test("AES192DecryptionTest", ModeECBTest::AESDecryptionTest<192>);
  Galileo::test("AES256EncryptionTest", ModeECBTest::AESEncryptionTest<256>);
  Galileo::test("AES256DecryptionTest", ModeECBTest::AESDecryptionTest<256>);
